	...
	function(){
		...
		function thumbView(){
			this.initThumbView = function(){
				...
				//},5000)
				$('#backButton').after('<div class="flipMapButton" id="listViewButton"><img class="optIcon" src="img/listIcon.png" alt="List" />List</div>');
				$('#backButton').after('<div class="flipMapButton" id="thumbButton"><img class="optIcon" src="img/thumbIcon.png" alt="Thumbs" />Thumbs</div>');	
				$('#backButton').after('<div class="flipMapButton" id="thumbButton2"><img class="optIcon" src="img/gridIcon.png" alt="Grid" />Grid</div>')
